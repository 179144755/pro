...
<div class="body" style="width: 100%;" id="app">
    ...
    <div class="gztitle">
        <div class="gztitle1">
            <input type="button"  v-on:click = "build_query_loadData({type:3})" value="毒品种类" class="button1">
            <input type="button"  v-on:click = "build_query_loadData({type:4})" value="毒品危害" class="button2">
        </div>
    </div>
